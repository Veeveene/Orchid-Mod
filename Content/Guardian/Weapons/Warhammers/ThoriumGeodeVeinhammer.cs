...
namespace OrchidMod.Content.Guardian.Weapons.Warhammers {
    ...
    public class GeodeVeinhammer : OrchidModGuardianHammer
    {
        ...
        public override void OnThrowTileCollide(Player player, OrchidGuardian guardian, Projectile projectile, Vector2 oldVelocity)
        {
            ...
            {
                Point collisionPoint = new Point((int)((projectile.Center.X + oldVelocity.X) / 16f), (int)((projectile.Center.Y + oldVelocity.Y) / 16f));
        ...
        // {
        //     TooltipLine tt = tooltips.FirstOrDefault(x => x.Name == "Damage");
        //     
        //     int knockbackIndex = tooltips.FindIndex(ttip => ttip.Mod == "Terraria" && ttip.Name == "Knockback");
        //     tooltips.Insert(knockbackIndex + 1,
        //         Main.LocalPlayer.GetBestPickaxe().pick > 0
        //             ? new TooltipLine(Mod, "PickPowerReadout", Language.GetTextValue("TestMod.Items.GeodeVeinhammer.PickPowerReadout", Main.LocalPlayer.GetBestPickaxe().pick))
        //             : new TooltipLine(Mod, "PickPowerUndefined", Language.GetTextValue("TestMod.Items.GeodeVeinhammer.PickPowerUndefined")));
        //             
        //     
        // }
    }
